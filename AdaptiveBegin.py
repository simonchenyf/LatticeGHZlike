...
Description:
    ...
    This code produces data for Fig. S2(a1) and Fig. S2(b1) in the Supplementary Information (SI),
    corresponding to F_Q/F_Q^eff = 0.6 (also called ratio in the SI).

    The name 'AdaptiveBegin' indicates that the parameter are swept with
    F_Q/F_Q^eff = 0.6 first, the results of which are used as starting points for
    F_Q/F_Q^eff = 0.7, and in turn, F_Q/F_Q^eff = 0.8.
