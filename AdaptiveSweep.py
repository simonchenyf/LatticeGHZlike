...
Description:
    ...
    This code produces data for Fig. S2(a2) and Fig. S2(b2) in the Supplementary Information (SI),
    corresponding to F_Q/F_Q^eff = 0.7 (also called ratio in the SI),
    and Fig. 3c and Fig. 3d in the main text, corresponding to F_Q/F_Q^eff = 0.8.

    Data for Fig. 3e and Fig.3f are also obtained using this code.
