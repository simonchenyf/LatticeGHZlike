...
Description:
    ...
    This code calculates the data for Fig. 3a and Fig. 3b, i.e. different F_Q/F_Q^eff
    values under different alpha (interaction range) and tau (pulse separation), and
    produces Fig. 3a and Fig. 3b in the main text..
